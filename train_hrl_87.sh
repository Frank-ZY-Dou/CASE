#!/bin/bash
# Train C-ASE HRL (High-Level Controller) with hybrid action space
#
...
#
# Prerequisites:
# 1. Train C-ASE low-level controller first: bash train_87.sh
...
--num_envs 4096 --nlabels 87 --numAMPObsSteps 20 --labellength 0 \
...
--experiment case_hrl_heading_87 \
